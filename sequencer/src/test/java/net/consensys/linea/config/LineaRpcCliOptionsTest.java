...
class LineaRpcCliOptionsTest {
    ...
    void toDomainObject_withDefaultCliOptions_shouldReturnDefaultConfiguration() {
        ...
        LineaRpcConfiguration expectedDefaultConfig = LineaRpcConfiguration.builder()
        ...
        assertEquals(expectedDefaultConfig.estimateGasCompatibilityModeEnabled(), actualConfig.estimateGasCompatibilityModeEnabled());
        assertEquals(expectedDefaultConfig.estimateGasCompatibilityMultiplier(), actualConfig.estimateGasCompatibilityMultiplier());
        assertEquals(expectedDefaultConfig.gaslessTransactionsEnabled(), actualConfig.gaslessTransactionsEnabled());
        assertEquals(expectedDefaultConfig.premiumGasMultiplier(), actualConfig.premiumGasMultiplier(), 0.001);
        assertEquals(expectedDefaultConfig.allowZeroGasEstimationForGasless(), actualConfig.allowZeroGasEstimationForGasless());
    ...
    void toDomainObject_withSpecificCliOptions_shouldReturnMatchingConfiguration() {
        ...
        LineaSharedGaslessConfiguration sharedConfig = getDefaultSharedConfig(); // Can use default or a custom one
        LineaRpcConfiguration actualConfig = cliOptions.toDomainObject(sharedConfig);
    ...
    void fromConfig_shouldSetCliOptionsCorrectly() {
        LineaSharedGaslessConfiguration sharedConfig = getDefaultSharedConfig();
        LineaRpcConfiguration sourceConfig = LineaRpcConfiguration.builder()
        ...
        assertEquals(sourceConfig.estimateGasCompatibilityModeEnabled(), convertedConfig.estimateGasCompatibilityModeEnabled());
        assertEquals(sourceConfig.estimateGasCompatibilityMultiplier(), convertedConfig.estimateGasCompatibilityMultiplier());
        assertEquals(sourceConfig.gaslessTransactionsEnabled(), convertedConfig.gaslessTransactionsEnabled());
        assertEquals(sourceConfig.premiumGasMultiplier(), convertedConfig.premiumGasMultiplier(), 0.001);
        assertEquals(sourceConfig.allowZeroGasEstimationForGasless(), convertedConfig.allowZeroGasEstimationForGasless());
    }
