...
public class LineaRlnValidatorCliOptions implements LineaCliOptions {
    ...
    @CommandLine.Option(
            ...
            arity = "1")
    private boolean rlnValidationEnabled = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnValidationEnabled();
    ...
    @CommandLine.Option(
            ...
            arity = "1")
    private String rlnProofServiceHost = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnProofServiceHost();
    ...
    @CommandLine.Option(
            ...
            arity = "1")
    private boolean rlnProofServiceUseTls = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnProofServiceUseTls();

    @CommandLine.Option(
            names = "--linea-rln-proof-cache-max-size",
            description = "Maximum number of proofs in the in-memory cache (default: ${DEFAULT-VALUE})",
            arity = "1")
    private long rlnProofCacheMaxSize = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnProofCacheMaxSize();

    @CommandLine.Option(
            names = "--linea-rln-proof-cache-expiry-seconds",
            description = "Time-to-live for proofs in the in-memory cache (seconds) (default: ${DEFAULT-VALUE})",
            arity = "1")
    private long rlnProofCacheExpirySeconds = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnProofCacheExpirySeconds();

    @CommandLine.Option(
            names = "--linea-rln-proof-stream-retries",
            description = "Max retries for gRPC stream connection (default: ${DEFAULT-VALUE})",
            arity = "1")
    private int rlnProofStreamRetries = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnProofStreamRetries();
    ...
    @CommandLine.Option(
            ...
            arity = "1")
    private long rlnProofStreamRetryIntervalMs = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnProofStreamRetryIntervalMs();
    ...
    @CommandLine.Option(
            ...
            arity = "1")
    private long rlnProofLocalWaitTimeoutMs = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnProofLocalWaitTimeoutMs();

    @CommandLine.Option(
            names = "--linea-rln-karma-service-url",
            description = "Optional URL to an HTTP service that provides user karma/tier information (default: none, overrides DB if specified)",
            arity = "1")
    private Optional<String> karmaServiceUrl = LineaRlnValidatorConfiguration.V1_DEFAULT.karmaServiceUrl();

    @CommandLine.Option(
            names = "--linea-rln-default-epoch-for-quota",
            description = "Default epoch identifier strategy (default: ${DEFAULT-VALUE})",
            arity = "1")
    private String defaultEpochForQuota = LineaRlnValidatorConfiguration.V1_DEFAULT.defaultEpochForQuota();
    
    @CommandLine.Option(
            names = "--linea-rln-jni-lib-path",
            description = "Optional explicit path to the rln_jni native library (default: system path lookup)",
            arity = "1")
    private Optional<String> rlnJniLibPath = LineaRlnValidatorConfiguration.V1_DEFAULT.rlnJniLibPath();

    @CommandLine.Mixin
    private LineaSharedGaslessCliOptions sharedGaslessCliOptions = LineaSharedGaslessCliOptions.create();
