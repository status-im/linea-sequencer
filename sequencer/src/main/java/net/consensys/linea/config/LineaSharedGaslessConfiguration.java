 ...
 *
 * @param denyListPath Path to the text file storing addresses of users on the deny list.
 *                     This file is read by the RPC estimateGas method and read/written by the RLN Validator.
 * @param denyListRefreshSeconds Interval in seconds at which the deny list file should be reloaded by components.
 * @param premiumGasPriceThresholdGWei Minimum gas price (in GWei) for a transaction to be considered premium.
 * @param denyListEntryMaxAgeMinutes Maximum age in minutes for an entry on the deny list before it expires.
 */
